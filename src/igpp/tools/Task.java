...
public class Task extends Thread
{
     ...
     **/
      ...
      * basename, pathname, path and extension as separate command line
      ...
      public void doTask(String pathName)
      {
		...
		if(mLister.length() > 0) {
     	...
     	for(FileItem item : list) {
     		...
     		variable.findAndSet("basename", igpp.util.File.getBaseName(item.getName()));
     		variable.findAndSet("extension", igpp.util.File.getExtension(item.getName()));
